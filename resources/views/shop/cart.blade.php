...
<body>
    ...
    <footer class="page-footer text-center font-small mt-4 wow fadeIn">
        ...
        <!--Call to action-->
        <div class="pt-4">
            <a class="btn btn-outline-white" href="#" target="_blank" role="button">Informasi Kontak
            </a>
            <a class="btn btn-outline-white" target="_blank" role="button">
        ...
        <div class="footer-copyright py-3">
            © 2019 Copyright:
            <a href="#" target="_blank"> Onlineshop </a>
        </div>
        <!--/.Copyright-->
